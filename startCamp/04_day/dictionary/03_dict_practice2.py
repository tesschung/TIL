...
library_list = ssafy['language']['python']['python standard library']
...
flag2 = False
if 'requests' in library_list:
    flag2 = True
print(flag2)

print('requests' in library_list)
print('os' in library_list)
...
print('오늘의 당번은',person)

print(ssafy['classes']['dj']['groups']['E'][0])
print(f"{ssafy['classes']['dj']['groups']['E'][0]}")