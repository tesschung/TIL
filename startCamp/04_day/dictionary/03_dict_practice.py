...
#for location in ssafy['location'].values():
#    print(location)
    #print(len(location))
...
#print(len(ssafy['language']['python']['python standard library']))
list_ = ssafy['language']['python']['python standard library']
if 'requests' not in list_:
    print('False')
...
#print(ssafy['classes']['dj']['groups']['E'])
e_list = ssafy['classes']['dj']['groups']['E']
#print(e_list)
person = random.choice(e_list)
print(person)
